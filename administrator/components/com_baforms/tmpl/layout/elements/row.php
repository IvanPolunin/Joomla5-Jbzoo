...
<div class="ba-form-row">
    <div class="ba-edit-item close-all-modals">
        <span class="ba-edit-wrapper edit-settings">
            ...
            <span class="ba-tooltip ba-top tooltip-delay ba-hide-element"><?php echo Text::_('ROW'); ?></span>
        </span>
        <div class="ba-buttons-wrapper">
            <span class="ba-edit-wrapper">
                <i class="zmdi zmdi-graphic-eq modify-columns"></i>
                <span class="ba-tooltip ba-top tooltip-delay settings-tooltip ba-hide-element"><?php echo Text::_('MODIFY_COLUMNS'); ?></span>
            </span>
            <span class="ba-edit-wrapper">
            ...
            <span class="ba-edit-text ba-hide-element"><?php echo Text::_('ROW'); ?></span>
        </div>
    </div>
