...
use Balbooa\Component\Forms\Administrator\Helper\BaformsHtmlJGrid;
...
$stateArray = array(Text::_('JUNPUBLISHED'), Text::_('JPUBLISHED'));
$stateValue = $state == '' ? Text::_('JSTATUS') : $stateArray[$state];
...
<form action="<?php echo Route::_('index.php?option=com_baforms'); ?>"
      method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
    <div id="forms-container">
        <div id="forms-content">
            <?php include(JPATH_COMPONENT.'/tmpl/layout/sidebar.php'); ?>
            <div class="ba-main-view">
                <div id="filter-bar">
                    <div class="app-title-wrapper">
                        <h1><?php echo Text::_('FORMS') ?></h1>
                    </div>
                            ...
                            <tr>
                                ...
                                <th class="status-th <?php echo $listOrder == 'published' ? 'active' : ''; ?>">
                                    <span data-sorting="published">
                                        <?php echo $stateValue; ?>
                                        <span class="ba-tooltip ba-top ba-hide-element"><?php echo Text::_('SORT_BY_COLUMN'); ?></span>
                                    </span>
                        ...
                        foreach ($this->items as $i => $item) {
                            ...
                            <tr>
                                ...
                                <td class="status-td">
                                    ...
                                    <?php echo BaformsHtmlJGrid::published($item->published, $i, 'forms.', $canChange); ?>
                                </td>
                                <td class="forms-title-td">
                                    <a href="<?php echo Route::_('index.php?option=com_baforms&task=form.edit&id='. $item->id); ?>">
                                        <?php echo $item->title; ?>
                                    </a>
                                </td>
                                <td>
...
<div class="ba-context-menu forms-context-menu" style="display: none">
    <span class="context-rename-form"><i class="zmdi zmdi-edit"></i><?php echo Text::_('RENAME'); ?></span>
    <span class="context-duplicate-form"><i class="zmdi zmdi-copy"></i><?php echo Text::_('JTOOLBAR_DUPLICATE'); ?></span>
    <span class="context-export-form"><i class="zmdi zmdi-download"></i><?php echo Text::_('EXPORT'); ?></span>
    <span class="context-copy-style-form"><i class="zmdi zmdi-roller"></i><?php echo Text::_('COPY_STYLE'); ?></span>
    <span class="context-paste-form"><i class="zmdi zmdi-assignment-o"></i><?php echo Text::_('PASTE'); ?></span>
    <span class="context-trash-form ba-group-element"><i class="zmdi zmdi-delete"></i><?php echo Text::_('TRASH'); ?></span>
</div>
<?php include(JPATH_COMPONENT.'/tmpl/layout/notification.php'); ?>