...
<?php
                    if ($message->type == 'total') {
                        ...
                        include(JPATH_COMPONENT.'/tmpl/layout/pdf-total-submission.php');
                    } else if ($message->type == 'signature') {
?>
                        <img src="<?php echo Uri::root().$message->message; ?>">
<?php
...
?>
                        <a target="_blank" href="<?php echo Uri::root().$this->uploaded_path; ?>/baforms/<?php echo $message->message; ?>">
                            View Uploaded File
                        </a>
<?php
                    }
