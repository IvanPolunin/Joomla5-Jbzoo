...
<link rel="stylesheet" type="text/css" href="<?php echo Uri::root().'components/com_baforms/assets/icons/material/material.css'; ?>">
<link rel="stylesheet" type="text/css" href="<?php echo Uri::root().'components/com_baforms/assets/icons/fontawesome/fontawesome.css'; ?>">
<?php
if (JVERSION >= '4.0.0') {
?>
...
?>
<script type="text/javascript" src="<?php echo Uri::root(); ?>media/jui/js/jquery.min.js"></script>
<?php
}
?>
    ...
    <div class="tab-content">
        <div id="fontawesome-tab" class="row-fluid tab-pane active">
            ...
            <div class="ba-icons-scroll-wrapper">
                <?php include(JPATH_COMPONENT.'/tmpl/layout/fontawesome.php'); ?>
            </div>
        </div>
        <div id="material-tab" class="row-fluid tab-pane">
            ...
            <div class="ba-icons-scroll-wrapper">
                <?php include(JPATH_COMPONENT.'/tmpl/layout/material.php'); ?>
            </div>
        </div>
    </div>
</div>
