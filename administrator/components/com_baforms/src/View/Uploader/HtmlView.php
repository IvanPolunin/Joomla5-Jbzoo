...
class HtmlView extends BaseHtmlView
{
    ...
    public function display ($tpl = null)
    {
        ...
        if (JVERSION >= '4.0.0') {
            ...
            $doc->addScript(Uri::root().'media/jui/js/jquery.min.js');
        }
        $doc->addScript(Uri::root().'administrator/components/com_baforms/assets/libraries/bootstrap/bootstrap.js');
        $doc->addScriptDeclaration('var $fileTypes = '.json_encode($this->fileTypes).', IMAGE_PATH = "'.BaformsHelper::$image_path.'";');
        ...
        if ($doc->getDirection() == 'rtl') {
            $doc->addStyleSheet(Uri::root().'components/com_baforms/assets/css/rtl-ba-style.css?'.$this->about->version);
        }
        if (!Factory::getUser()->authorise('core.edit', 'com_baforms')) {
