...
/**
 * Methods supporting a list of Selectcity records.
 *
 * @since  1.0.0
 */
class SelectcitysModel extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		if (!Factory::getApplication()->getIdentity()->authorise('core.edit', 'com_selectcity'))
		{
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(Text::_("COM_SELECTCITY_SEARCH_FILTER_DATE_FORMAT"), "warning");
