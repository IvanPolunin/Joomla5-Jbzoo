...
!function($) {
    var each = tinymce.each, htmlSchema = new tinymce.html.Schema({
        schema: "mixed"
    }), mediatypes = [ "flash", "quicktime", "audio", "video", "iframe" ], defaultMediaAttributes = {
        flash: {
            play: !0,
            loop: !0,
            menu: !0,
    ...
    var MediaManagerDialog = {
        ...
        init: function() {
            ...
            var data, attribs, val, type, x, self = this, ed = tinyMCEPopup.editor, elm = ed.selection.getNode(), mediatype = "video", mediaApi = ed.plugins.media;
            ...
            }), WFAggregator.setup(), /mce-object/.test(elm.className) ? (data = mediaApi.getMediaData(), 
