...
!function() {
    ...
    tinymce.PluginManager.add("columns", function(editor, url) {
        ...
        editor.onPreProcess.add(function(editor, o) {
            ...
            var form, columnsNum, layoutList, stackList, gapList, stylesList, ctrl;
            ...
            (ctrl = cm.createSplitButton("columns", {
                ...
                onclick: function() {
                    editor.windowManager.open({
                        ...
                        open: function() {
                            var cols, cls, nodes = Columns.getSelectedBlocks(editor), stack = editor.getParam("columns_stack", "medium"), gap = editor.getParam("columns_gap", "medium"), num = editor.getParam("columns_num", 1), layout = editor.getParam("columns_layout", "");
