...
<?php if (!empty($groupList)) : ?>
    <fieldset>
        ...
        <legend><?php echo Text::_('JBZOO_ADMIN_POSITIONS_LIBS'); ?></legend>
        ...
        <div class="groups">
            <?php foreach ($groupList as $groupKey => $groupItems) : ?>
                ...
                <div class="elements-group-name">
                    <?php
                    echo $this->app->jbstring->_('JBZOO_ADMIN_POSITIONS_LIST_' . $groupKey, Text::_('JBZOO_ADMIN_POSITIONS_LIST'));
                    ?>
                </div>
                ...
                <ul class="elements jsElementsGroup" data-group="<?php echo $groupKey; ?>">
                    ...
                    <?php foreach ($groupItems as $itemKey => $element) {
                        ...
                        echo '<li ' . $this->app->jbhtml->buildAttrs($attrs) . '>'
                            ...
                            . ($element->isCore() ? ' <em>(' . Text::_('JBZOO_ELEMENT_CORE') . ')</em>' : '')
                            . '</li>'
                            . PHP_EOL;
                    }
                    ?>
