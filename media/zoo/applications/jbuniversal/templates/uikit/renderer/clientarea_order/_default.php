...
<div class="jbclientarea-tab-headers">
    ...
    <ul class="uk-tab" data-uk-tab="{connect:'#<?php echo $tabsId; ?>'}">
        ...
        <li class="uk-active">
            <a href="#"><?php echo Text::_('JBZOO_CLIENTAREA_ORDERINFO'); ?></a>
        </li>

        <?php if ($payment = $order->getPayment()) : ?>
            <li>
                <a href="#"><?php echo Text::_('JBZOO_CLIENTAREA_PAYMENT'); ?></a>
            </li>
        <?php endif; ?>

        <?php if ($shipping = $order->getShipping()) : ?>
            <li>
                <a href="#"><?php echo Text::_('JBZOO_CLIENTAREA_SHIPPING'); ?></a>
            </li>
        <?php endif; ?>

        <?php if (StringHelper::trim(strip_tags($html))) : ?>
            <li>
                <a href="#"><?php echo Text::_('JBZOO_CLIENTAREA_USERINFO'); ?></a>
            </li>
        <?php endif; ?>
