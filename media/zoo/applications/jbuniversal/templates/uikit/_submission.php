...
<?php if ($this->errors) :
    ...
    $msg = count($this->errors) > 1 ? Text::_('Oops. There were errors in your submission.') : Text::_('Oops. There was an error in your submission.');
    $msg .= ' '.Text::_('Please take a look at all highlighted fields, correct your data and try again.'); ?>
...
<form id="item-submission" class="uk-form" action="<?php echo $formAction; ?>"
    ...
    <div class="uk-margin uk-text-center jbform-actions">
        ...
        <button type="submit" id="submit-button" class="uk-button uk-button-large uk-button-success">
            ...
            <?php echo $this->item->id ? Text::_('Save') : Text::_('Submit Item'); ?>
        </button>
