...
<div <?php echo $this->app->jbhtml->buildAttrs($wrapAttrs); ?>>
    <div class="jbcompare-active">
        <a rel="nofollow" href="<?php echo $compareUrl; ?>" class="uk-button uk-button-success" title="<?php echo Text::_('JBZOO_COMPARE_ITEMS'); ?>">
            <i class="uk-icon-bar-chart"></i>
        </a>
        <span class="uk-button uk-button-danger jsCompareToggle" title="<?php echo Text::_('JBZOO_COMPARE_REMOVE'); ?>">
            <i class="uk-icon-trash"></i>
        </span>
    </div>
    <div class="jbcompare-unactive">
        <span class="uk-button uk-button-success jsCompareToggle" title="<?php echo Text::_('JBZOO_COMPARE_ADD'); ?>">
