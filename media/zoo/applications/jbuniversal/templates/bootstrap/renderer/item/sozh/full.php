...
foreach ($item->getElementsByType('schema') as $schemaElement) {
    $schemaElement->render();
    break;
}
   ...
   <div class="<?php echo $rowClass; ?>">
      <div class="<?php echo $bootstrap->gridClass(3); ?>">
         <div class="item-image">
            <!--<img src="<?php echo JURI::base().'/images/sozh.png'; ?>" width="400" height="453" alt=".охлаждающая жидкость, СОЖ" />-->
...
<?php
$modulePosition = 'item-forms';
$modules = \Joomla\CMS\Helper\ModuleHelper::getModules($modulePosition);
if (!empty($modules)) {
    $attribs = array('style' => 'html5');
    echo '<div class="item-module-position mt-5 bg-light p-3">';
