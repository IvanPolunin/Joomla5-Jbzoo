...
<div class="jbclientarea-tab-headers">
    ...
    <ul id="<?php echo $tabsId; ?>" class="nav nav-tabs">
        ...
        <li class="active">
            <a data-toggle="tab" href="#orderinfo"><?php echo Text::_('JBZOO_CLIENTAREA_ORDERINFO'); ?></a>
        </li>

        <?php if ($payment = $order->getPayment()) : ?>
            <li>
                <a data-toggle="tab" href="#payment"><?php echo Text::_('JBZOO_CLIENTAREA_PAYMENT'); ?></a>
            </li>
        <?php endif; ?>

        <?php if ($shipping = $order->getShipping()) : ?>
            <li>
                <a data-toggle="tab" href="#shipping"><?php echo Text::_('JBZOO_CLIENTAREA_SHIPPING'); ?></a>
            </li>
        <?php endif; ?>

        <?php if (StringHelper::trim(strip_tags($html))) : ?>
            <li>
                <a data-toggle="tab" href="#userinfo"><?php echo Text::_('JBZOO_CLIENTAREA_USERINFO'); ?></a>
            </li>
        <?php endif; ?>
