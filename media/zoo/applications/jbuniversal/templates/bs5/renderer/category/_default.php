...
$description = $this->app->string->trim($category->description);
...
if ((int)$vars['params']->get('template.category_show', 1)) : ?>
    <div class="category alias-<?php echo $category->alias; ?> ">
        ...
        <?php if ((int)$vars['params']->get('template.category_image', 1) && isset($image['src']) && $image['src']) : ?>
            <div class="image-full float-<?php echo $vars['params']->get('template.category_image_align', 'left'); ?>">
