...
<div id="edit" class="uk-article-divider" style="display:none">
    ...
    <form class="style short uk-form" method="post" action="<?php echo $this->app->link(array('controller' => 'comment', 'task' => 'edit')); ?>">
        ...
        <div class="actions uk-form-row">
            <input name="submit" type="submit" value="<?php echo Text::_('Save comment'); ?>" accesskey="s" class="uk-button uk-button-success" />
            <a class="comment-cancelEdit uk-button uk-button-danger" href="#edit"><?php echo Text::_('Cancel'); ?></a>
        </div>
