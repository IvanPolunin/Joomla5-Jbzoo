...
<div <?php echo $this->app->jbhtml->buildAttrs($wrapAttrs); ?>>
    <div class="jbfavorite-active">
        <a rel="nofollow" href="<?php echo $favoriteUrl; ?>" class="btn btn-primary"
           data-toggle="tooltip" data-placement="top" title="<?php echo Text::_('JBZOO_FAVORITE_ITEMS'); ?>">
            <?php echo $bootstrap->icon('heart', array('type' => 'white')); ?>
            <?php echo Text::_('JBZOO_FAVORITE'); ?>
        </a>

        <span class="btn btn-danger jsFavoriteToggle" title="<?php echo Text::_('JBZOO_FAVORITE_REMOVE_ITEM'); ?>">
    ...
    <div class="jbfavorite-unactive">
        <span class="btn btn-primary jsFavoriteToggle" data-toggle="tooltip" data-placement="top"
              title="<?php echo Text::_('JBZOO_FAVORITE_ADD'); ?>">
            <?php echo $bootstrap->icon('heart', array('type' => 'white')); ?>
        </span>
    </div>
</div><!--/noindex-->
