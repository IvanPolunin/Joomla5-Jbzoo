...
<div class="item-tabs">
    <ul id="<?php echo $tabsId; ?>" class="nav nav-tabs">
        ...
        <?php if ($this->checkPosition('adaptation')) : ?>
            <li class="active">
                <a href="#item-adaptation" id="adaptation-tab" data-toggle="tab" class="active">
        ...
        <?php if ($this->checkPosition('price')) : ?>
            <li>
                <a href="#item-price" id="price-tab" data-toggle="tab">
    ...
    <div id="<?php echo $tabsId; ?>Content" class="tab-content">
        ...
        <?php if ($this->checkPosition('adaptation')) : ?>
            <div class="tab-pane fade active in" id="item-adaptation">
        ...
        <?php if ($this->checkPosition('price')) : ?>
            <div class="tab-pane fade" id="item-price">
