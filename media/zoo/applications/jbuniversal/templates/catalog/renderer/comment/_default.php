...
// set author name
$vars['author']->name = $vars['author']->name ? $vars['author']->name : Text::_('Anonymous');
        ...
        <div id="comment-<?php echo $comment->id; ?>" class="comment <?php if ($author->isJoomlaAdmin())
            ...
            <div class="comment-body">
                ...
                <?php if ($comment->getItem()->isCommentsEnabled()) : ?>
                    <p><a class="reply jbbutton small green" href="#" rel="nofollow"><?php echo Text::_('Reply'); ?></a>
                        <?php if ($comment->canManageComments()) : ?>

                            <a class="edit jbbutton small" href="#" rel="nofollow"><?php echo Text::_('Edit'); ?></a>
