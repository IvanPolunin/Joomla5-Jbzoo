...
<div id="edit" style="display:none">
    ...
    <form class="style short" method="post" action="<?php echo $this->app->link(array('controller' => 'comment', 'task' => 'edit')); ?>">
        ...
        <div class="actions">
            <input name="submit" class="jbbutton green" type="submit" value="<?php echo Text::_('Save comment'); ?>" accesskey="s" />
            <a class="comment-cancelEdit jbbutton" href="#edit"><?php echo Text::_('Cancel'); ?></a>
        </div>
