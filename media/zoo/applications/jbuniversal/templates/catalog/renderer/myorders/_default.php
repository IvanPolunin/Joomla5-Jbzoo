...
if (count($vars['objects'])) : ?>
    <table class="jbbasket-table" border="1" cellpadding="3" cellspacing="3">
        ...
        <tr>
            <th>#</th>
            <th><?php echo Text::_('JBZOO_MYORDERS_NAME'); ?></th>
            <th><?php echo Text::_('JBZOO_MYORDERS_PRICE'); ?></th>
            <th><?php echo Text::_('JBZOO_MYORDERS_STATUS'); ?></th>
        </tr>
        </thead>
        <tbody>
        <?php
...
<?php else: ?>
    <p style="color:#a00;"><?php echo Text::_('JBZOO_MYORDERS_EMPTY'); ?></p>
<?php endif;
