...
if ($view->layoutType == 'h') {
    $html[] = '<a href="' . $verticalUrl . '" class="jbbutton small">' . Text::_('JBZOO_COMPARE_VERTICAL') . '</a>';
} else {
    $html[] = '<a href="' . $horizontalUrl . '" class="jbbutton small">' . Text::_('JBZOO_COMPARE_HORIZONTAL') . '</a>';
}
$html[] = '<a href="' . $clearUrl . '" class="jbbutton small orange jbcompare-clear">' . Text::_('JBZOO_COMPARE_REMOVEALL') . '</a>';
$html[] = '</div>';
