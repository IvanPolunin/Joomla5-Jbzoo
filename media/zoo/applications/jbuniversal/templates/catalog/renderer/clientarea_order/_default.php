...
<div class="jbclientarea">
    ...
    <table class="jbclientarea-order-table">
        ...
        <tr>
            ...
            <th class="jbclientarea-info"><?php echo Text::_('JBZOO_CLIENTAREA_ITEM_NAME'); ?></th>
            <th class="jbclientarea-price4one"><?php echo Text::_('JBZOO_CLIENTAREA_ITEM_PRICE'); ?></th>
            <th class="jbclientarea-quantity"><?php echo Text::_('JBZOO_CLIENTAREA_ITEM_QUANTITY'); ?></th>
            <th class="jbclientarea-totalsum"><?php echo Text::_('JBZOO_CLIENTAREA_ITEM_TOTALSUM'); ?></th>
        </tr>
        </thead>
            ...
            <tr class="jbclientarea-shipping">
                ...
                <td class="jbclientarea-info" colspan="2">
                    ...
                    if ($shipping->isFree()) {
                        ...
                        echo Text::sprintf('JBZOO_ORDER_SHIPPING_IF_FREE', $priceCost->html());
                    }
                    ?>
                </td>
        ...
        <tr class="jbclientarea-total">
            <td class="jbclientarea-emptycell"></td>
            <td class="jbclientarea-label" colspan="3"><?php echo Text::_('JBZOO_ORDER_ITEM_TOTAL') ?>:</td>
...
<div id="<?php echo $tabsId; ?>">
    <ul>
        <li>
            <a href="#tab-basic-info"><?php echo Text::_('JBZOO_CLIENTAREA_ORDERINFO'); ?></a>
        </li>

        <?php if ($payment = $order->getPayment()) : ?>
            <li>
                <a href="#tab-payment"><?php echo Text::_('JBZOO_CLIENTAREA_PAYMENT'); ?></a>
            </li>
        <?php endif; ?>

        <?php if ($shipping = $order->getShipping()) : ?>
            <li>
                <a href="#tab-shipping"><?php echo Text::_('JBZOO_CLIENTAREA_SHIPPING'); ?></a>
            </li>
        <?php endif; ?>

        <?php if (StringHelper::trim(strip_tags($html))) : ?>
            <li>
                <a href="#tab-form-fields"><?php echo Text::_('JBZOO_CLIENTAREA_USERINFO'); ?></a>
            </li>
        <?php endif; ?>
    </ul>

    <div id="tab-basic-info" class="jbclientarea-basicinfo">
        <h3><?php echo Text::_('JBZOO_CLIENTAREA_ORDERINFO'); ?></h3>
        <dl>
            <dt><?php echo Text::_('JBZOO_CLIENTAREA_STATUS'); ?></dt>
            <dd><p><?php echo $order->getStatus()->getName(); ?></p></dd>

            <dt><?php echo Text::_('JBZOO_CLIENTAREA_ORDERNO'); ?></dt>
            <dd><p><?php echo $order->getName(); ?></p></dd>

            <dt><?php echo Text::_('JBZOO_CLIENTAREA_CREATED'); ?></dt>
            <dd><p><?php echo $created; ?></p></dd>

            <dt><?php echo Text::_('JBZOO_CLIENTAREA_MODIFIED'); ?></dt>
    ...
    <?php if ($payment = $order->getPayment()) : ?>
        <div id="tab-payment" class="jbclientarea-payment">
            <h3><?php echo Text::_('JBZOO_CLIENTAREA_PAYMENT'); ?></h3>
            <dl>
                <dt><?php echo Text::_('JBZOO_CLIENTAREA_PAYMENT_NAME'); ?></dt>
                <dd><p><?php echo $payment->getName(); ?></p></dd>

                <dt><?php echo Text::_('JBZOO_CLIENTAREA_PAYMENT_RATE'); ?></dt>
                <dd><p><?php echo $payment->getRate()->html(); ?></p></dd>

                <dt><?php echo Text::_('JBZOO_CLIENTAREA_PAYMENT_SUMMA'); ?></dt>
                <dd><p><?php echo $order->getTotalSum(true)->html(); ?></p></dd>

                <dt><?php echo Text::_('JBZOO_CLIENTAREA_PAYMENT_STATUS'); ?></dt>
                ...
                <?php if (!$payment->isPaid() && ($checkoutUrl = $payment->getRedirectUrl())) : ?>
                    <dd>
                        <a target="_blank" class="jbbutton green" href="<?php echo $checkoutUrl; ?>">
                            <?php echo Text::_('JBZOO_CLIENTAREA_PAYMENT_GOTO_CHECKOUT'); ?></a>
                    </dd>
                <?php endif; ?>
            </dl>
        </div>
    ...
    <?php if ($shipping = $order->getShipping()) : ?>
        <div id="tab-shipping" class="jbclientarea-shipping">
            <h3><?php echo Text::_('JBZOO_CLIENTAREA_SHIPPING'); ?></h3>
            <dl>
                <?php echo $view->shippingRenderer->renderAdminPosition(array('style' => 'order.useredit', 'order' => $order)); ?>

                <dt><?php echo Text::_('JBZOO_CLIENTAREA_SHIPPING_RATE'); ?></dt>
                <dd>
                    <p><?php echo $shipping->getRate()->html(); ?></p>
                </dd>

                <dt><?php echo Text::_('JBZOO_CLIENTAREA_SHIPPING_STATUS'); ?></dt>
                <dd>
    ...
    <?php if (StringHelper::trim(strip_tags($html))) : ?>
        <div id="tab-form-fields" class="jbclientarea-formfields">
            <h3><?php echo Text::_('JBZOO_CLIENTAREA_USERINFO'); ?></h3>
            <dl>
                <?php echo $html; ?>
            </dl>
        </div>
