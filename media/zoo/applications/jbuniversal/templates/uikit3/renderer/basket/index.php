...
<?php if (count($view->items) == 0) : ?>
    <p class="jbcart-empty-message"><?php echo Text::_('JBZOO_CART_ITEMS_NOT_FOUND'); ?></p>
...
<?php else:
    ...
    $this->app->jbassets->widget('.jbzoo .jsJBZooCart', 'JBZoo.Cart', array(
        'text_remove_all'  => Text::_('JBZOO_CART_CLEANUP'),
        'text_remove_item' => Text::_('JBZOO_CART_REMOVE_ITEM'),
