...
$this->app->document->setTitle(Text::_('JBZOO_CLIENTAREA_ORDERS_TITLE'));
...
<div class="jbclientarea">
    ...
    <p class="jbclientarea-page-desc"><?php echo Text::_('JBZOO_CLIENTAREA_DESCRIPTION'); ?>:</p>
    ...
    <?php if (!empty($vars['objects'])) : ?>
        ...
        <table class="jbclientarea-orderlist">
            <thead>
            <tr>
                <th><?php echo Text::_('JBZOO_CLIENTAREA_ID'); ?></th>
                <th><?php echo Text::_('JBZOO_CLIENTAREA_DATE'); ?></th>
                <th><?php echo Text::_('JBZOO_CLIENTAREA_PRICE'); ?></th>
                <th><?php echo Text::_('JBZOO_CLIENTAREA_STATUS'); ?></th>
            </tr>
            </thead>
    ...
    <?php else: ?>
        <p class="jbclientarea-empty"><?php echo Text::_('JBZOO_CLIENTAREA_EMPTY'); ?></p>
    <?php endif; ?>
