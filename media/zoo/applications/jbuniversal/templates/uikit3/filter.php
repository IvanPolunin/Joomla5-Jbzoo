...
if (!$this->app->jbcache->start()) {
    ...
    ?><h1 class="title"><?php echo $this->title ? $this->title : Text::_('JBZOO_SEARCH_RESULT'); ?></h1><?php

    if ($this->items) {

        echo '<p>' . Text::_('JBZOO_FILTER_TOTAL_RESULT') . ': ' . $this->itemsCount . '</p>';
        ...
        ?><p><?php echo Text::_('JBZOO_FILTER_ITEMS_NOT_FOUND'); ?></p><?php
